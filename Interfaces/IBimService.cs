...
namespace MUCOBADI.Interfaces
{
    ...
    //{
    //    Task<List<BusinessPlanHeader>?> GetBusinessPlan(string? DistrictId, string? SubcountyId, string? HouseholdId, string? NatureofResidenceId, string? CategoryofResidenceId);
